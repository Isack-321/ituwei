package com.ituwei.polls.service;
...
import com.ituwei.polls.Model.Choice;
import com.ituwei.polls.Model.ChoiceVoteCount;
import com.ituwei.polls.Model.Poll;
import com.ituwei.polls.Model.User;
import com.ituwei.polls.Model.Vote;
...
import com.ituwei.polls.exception.*;
...
import com.ituwei.polls.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        Poll poll = pollRepository.findById(pollId).orElseThrow(() -> new ResourceNotFound("Poll", "id", pollId));
        ...
        User creator = userRepository.findById(poll.getCreatedBy())
                .orElseThrow(() -> new ResourceNotFound("User", "id", poll.getCreatedBy()));
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        Choice selectedChoice = poll.getChoices().stream()
                ...
                .orElseThrow(() -> new ResourceNotFound("Choice", "id", voteRequest.getChoiceId()));
